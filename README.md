...
This repository contains the conceptual definition and theoretical framework for **Model Listing**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── model-listing.tex    # LaTeX dissertation
├── whitepaper/
│   └── model-listing.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025modellisting,
  author = {Vega, Adam Eren},
  title = {Model Listing: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/model-listing}
}
```
